...
COMPRESS_TIMEOUT=600   # 10 minutes (v6 is 157× slower than v5, needs more time)
DECOMPRESS_TIMEOUT=300 # 5 minutes (safety margin for v6 decompression)
...
G07_VERSIONS=()
SKIP_VERSIONS=""  # Include all versions (including v6 for complete results)
...
for file in "$DATA_DIR"/*; do
    ...
    # Test all detected G07 versions (no flags - all versions use hardcoded optimal settings)
