...
void print_usage(const char* program_name) {
    std::cout << "═══════════════════════════════════════════════════════\n";
    std::cout << "  G07 v9.0 - Fast Lossless Compression\n";
    std::cout << "═══════════════════════════════════════════════════════\n";
...
int main(int argc, char* argv[]) {
    // G07 v9.0 - Simplified interface: just input and output files
    if (argc != 3) {
        print_usage(argv[0]);
        return 1;
    }
    ...
    try {
        ...
        const bool candidate_logging_enabled = env_flag_enabled("G07_V9_CANDIDATE_LOG");
